 ...
 * @subpackage Wp_Freela_Erp/admin
 */
...
class WF_Admin {
	...
	public function enqueue_styles() {
		 ...
		 * defined in WF_Loader as all of the hooks are defined
		 * in that particular class.
		 *
		 * The WF_Loader will then create the relationship
		 * between the defined hooks and the functions defined in this
		 * class.
		 */

		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/wp-freela-erp-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/wp-freela-erp-admin.js', array( 'jquery' ), $this->version, false );
	...
	public function add_plugin_admin_menu() {
	    ...
	    add_menu_page( 'WP Freela ERP', 'WP Freela', 'manage_options', $this->plugin_name, array($this, 'display_plugin_setup_page'), 'dashicons-chart-line', 3 );

 ...
 */
class Wp_Freela_Erp_Post_Types {
    ...
    private function register_single_post_type( $fields ) {
        ...
        $labels = array(
            ...
            'new_item'              => sprintf( __( 'New %s', 'wp-freela-erp' ), $fields['singular'] ),
            'add_new_item'          => sprintf( __( 'Add new %s', 'wp-freela-erp' ), $fields['singular'] ),
            'edit_item'             => sprintf( __( 'Edit %s', 'wp-freela-erp' ), $fields['singular'] ),
            'view_item'             => sprintf( __( 'View %s', 'wp-freela-erp' ), $fields['singular'] ),
            'view_items'            => sprintf( __( 'View %s', 'wp-freela-erp' ), $fields['plural'] ),
            'search_items'          => sprintf( __( 'Search %s', 'wp-freela-erp' ), $fields['plural'] ),
            'not_found'             => sprintf( __( 'No %s found', 'wp-freela-erp' ), strtolower( $fields['plural'] ) ),
            'not_found_in_trash'    => sprintf( __( 'No %s found in trash', 'wp-freela-erp' ), strtolower( $fields['plural'] ) ),
            'all_items'             => sprintf( __( 'All %s', 'wp-freela-erp' ), $fields['plural'] ),
            'archives'              => sprintf( __( '%s Archives', 'wp-freela-erp' ), $fields['singular'] ),
            'attributes'            => sprintf( __( '%s Attributes', 'wp-freela-erp' ), $fields['singular'] ),
            'insert_into_item'      => sprintf( __( 'Insert into %s', 'wp-freela-erp' ), strtolower( $fields['singular'] ) ),
            'uploaded_to_this_item' => sprintf( __( 'Uploaded to this %s', 'wp-freela-erp' ), strtolower( $fields['singular'] ) ),
            /* Labels for hierarchical post types only. */
            'parent_item'           => sprintf( __( 'Parent %s', 'wp-freela-erp' ), $fields['singular'] ),
            'parent_item_colon'     => sprintf( __( 'Parent %s:', 'wp-freela-erp' ), $fields['singular'] ),
    ...
    private function register_single_post_type_taxnonomy( $tax_fields ) {
        $labels = array(
            ...
            'all_items'                  => sprintf( __( 'All %s' , 'wp-freela-erp' ), $tax_fields['plural'] ),
            'edit_item'                  => sprintf( __( 'Edit %s' , 'wp-freela-erp' ), $tax_fields['single'] ),
            'view_item'                  => sprintf( __( 'View %s' , 'wp-freela-erp' ), $tax_fields['single'] ),
            'update_item'                => sprintf( __( 'Update %s' , 'wp-freela-erp' ), $tax_fields['single'] ),
            'add_new_item'               => sprintf( __( 'Add New %s' , 'wp-freela-erp' ), $tax_fields['single'] ),
            'new_item_name'              => sprintf( __( 'New %s Name' , 'wp-freela-erp' ), $tax_fields['single'] ),
            'parent_item'                => sprintf( __( 'Parent %s' , 'wp-freela-erp' ), $tax_fields['single'] ),
            'parent_item_colon'          => sprintf( __( 'Parent %s:' , 'wp-freela-erp' ), $tax_fields['single'] ),
            'search_items'               => sprintf( __( 'Search %s' , 'wp-freela-erp' ), $tax_fields['plural'] ),
            'popular_items'              => sprintf( __( 'Popular %s' , 'wp-freela-erp' ), $tax_fields['plural'] ),
            'separate_items_with_commas' => sprintf( __( 'Separate %s with commas' , 'wp-freela-erp' ), $tax_fields['plural'] ),
            'add_or_remove_items'        => sprintf( __( 'Add or remove %s' , 'wp-freela-erp' ), $tax_fields['plural'] ),
            'choose_from_most_used'      => sprintf( __( 'Choose from the most used %s' , 'wp-freela-erp' ), $tax_fields['plural'] ),
            'not_found'                  => sprintf( __( 'No %s found' , 'wp-freela-erp' ), $tax_fields['plural'] ),
        );
        $args = array(
    ...
    public function create_custom_post_type() {
        ...
        $post_types_fields = array(
            ...
            array(
                ...
                'description'           => __('A CPT to controll the projects.','wp-freela-erp'),
                'has_archive'           => true,
                'hierarchical'          => false,
                'menu_icon'             => 'dashicons-hammer',
                'rewrite' => array(
                    'slug'                  => __('jobs','wp-freela-erp'),
                    'with_front'            => true,
                    'pages'                 => true,
                    'feeds'                 => true,
